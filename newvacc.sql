...
Source Database       : newvacc

Target Server Type    : MYSQL
Target Server Version : 50721
File Encoding         : 65001

Date: 2023-10-25 16:47:41
*/
...
CREATE TABLE `area` (
  ...
  KEY `cityID_FK` (`father`) USING BTREE,
  CONSTRAINT `cityID_FK` FOREIGN KEY (`father`) REFERENCES `city` (`cityID`)
) ENGINE=InnoDB AUTO_INCREMENT=3145 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `city` (
  ...
  KEY `provinceID_FK` (`father`) USING BTREE,
  CONSTRAINT `provinceID_FK` FOREIGN KEY (`father`) REFERENCES `province` (`provinceID`)
...
-- ----------------------------
-- Table structure for crowd_type
-- ----------------------------
DROP TABLE IF EXISTS `crowd_type`;
...
-- ----------------------------
-- Records of crowd_type
-- ----------------------------
INSERT INTO `crowd_type` VALUES ('1', '愿检尽检（自费）');
INSERT INTO `crowd_type` VALUES ('2', '应检尽检（凭相关证明免费）');

-- ----------------------------
-- Table structure for detection_point
-- ----------------------------
DROP TABLE IF EXISTS `detection_point`;
CREATE TABLE `detection_point` (
...
-- ----------------------------
-- Records of detection_point
-- ----------------------------
INSERT INTO `detection_point` VALUES ('1', null, '从化区城鳌大道999', '从化医院', '2023-01-12 00:00:00', '2023-01-20 00:00:00');
INSERT INTO `detection_point` VALUES ('2', null, '广州市黄埔区999', '广州市中心医院', '2022-09-14 17:13:36', '2022-09-22 00:00:00');
INSERT INTO `detection_point` VALUES ('4', null, '广州市黄埔区999', '广州市中心医院2', '2022-09-14 18:15:51', '2022-09-23 00:00:00');
INSERT INTO `detection_point` VALUES ('5', null, '北海市', '北海医院', '2022-10-12 00:00:00', '2022-10-12 23:59:59');
INSERT INTO `detection_point` VALUES ('6', null, '云浮市云天路876号', '云浮市中医院', '2022-11-24 00:00:00', '2022-11-30 23:59:59');
INSERT INTO `detection_point` VALUES ('7', null, '从化区城鳌大道999', '从化医院', '2023-01-17 00:00:00', '2023-01-30 00:00:00');
INSERT INTO `detection_point` VALUES ('8', '110101', '999路999号', '仁和医院2', '2023-01-04 00:00:00', '2023-01-21 00:00:00');
INSERT INTO `detection_point` VALUES ('9', '440106', '999路999号', '仁和医院', '2023-01-05 04:05:11', '2023-01-16 00:00:00');
INSERT INTO `detection_point` VALUES ('11', '370202', '999路999号', '从化医院3', '2023-01-19 00:00:00', '2023-01-22 00:00:00');
INSERT INTO `detection_point` VALUES ('12', '360403', '999路998号', '仁和医院6', '2023-01-18 00:00:00', '2023-01-27 00:00:00');
INSERT INTO `detection_point` VALUES ('14', '120223', '从化999999999', 'ssssssssssssss', '2023-08-14 16:07:24', '2023-08-23 00:00:00');
...
-- Records of document
-- ----------------------------
INSERT INTO `document` VALUES ('1', '居民身份证');
INSERT INTO `document` VALUES ('2', '港澳居民来往内地通行证');
INSERT INTO `document` VALUES ('3', '台湾居民来往内地通行证');
INSERT INTO `document` VALUES ('4', '外国人永久居留身份证');
INSERT INTO `document` VALUES ('5', '护照');
INSERT INTO `document` VALUES ('6', '其他');
INSERT INTO `document` VALUES ('7', '港澳台居民居住证');
INSERT INTO `document` VALUES ('8', '出生医学证明');

-- ----------------------------
-- Table structure for general_sampling
-- ----------------------------
DROP TABLE IF EXISTS `general_sampling`;
CREATE TABLE `general_sampling` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `tel` varchar(24) NOT NULL,
  `document_type` int(11) NOT NULL,
  `document_No` varchar(24) NOT NULL,
  `sex` varchar(4) NOT NULL,
  `birthday` datetime NOT NULL,
  `country` varchar(50) NOT NULL,
  `age` int(4) NOT NULL,
  `current_residence` varchar(50) DEFAULT NULL,
  `detailed_address` varchar(200) DEFAULT NULL,
  `crowd_typeId` int(11) NOT NULL,
  `inspect_typeId` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `crowd_typeId_FK` (`crowd_typeId`) USING BTREE,
  KEY `inspect_typeId_FK` (`inspect_typeId`) USING BTREE,
  CONSTRAINT `crowd_typeId_FK` FOREIGN KEY (`crowd_typeId`) REFERENCES `crowd_type` (`id`),
  CONSTRAINT `inspect_typeId_FK` FOREIGN KEY (`inspect_typeId`) REFERENCES `inspect_type` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of general_sampling
-- ----------------------------
...
CREATE TABLE `healthreport` (
  ...
  `cough` varchar(4) NOT NULL COMMENT '是否咳嗽，y咳嗽，n不咳嗽',
  `temperature` varchar(4) NOT NULL COMMENT '体温是否大于37.3度，y是，n不是',
  `departureArea` varchar(50) NOT NULL COMMENT '出发地区id',
  `arrivalArea` varchar(50) NOT NULL COMMENT '到达地区id',
  `address` varchar(255) NOT NULL COMMENT '到达地区住处',
...
-- ----------------------------
INSERT INTO `healthreport` VALUES ('1', '2023-02-01 15:26:11', 'n', 'n', '广东省广州市从化区', '广东省广州市增城区', '桃花路999号', '2');
INSERT INTO `healthreport` VALUES ('2', '2023-07-20 15:09:52', 'y', 'y', '', '', '', '2');
INSERT INTO `healthreport` VALUES ('3', '2023-07-20 15:10:02', 'n', 'n', '', '', '', '2');
INSERT INTO `healthreport` VALUES ('4', '2023-07-20 16:00:44', 'n', 'n', '', '', '', '9');
INSERT INTO `healthreport` VALUES ('5', '2023-08-14 16:54:44', 'y', 'y', '', '', '', '15');
INSERT INTO `healthreport` VALUES ('6', '2023-10-25 16:46:35', 'n', 'n', '', '', '', '31');

-- ----------------------------
-- Table structure for inoculation_history
-- ----------------------------
DROP TABLE IF EXISTS `inoculation_history`;
CREATE TABLE `inoculation_history` (
  `historyId` bigint(20) NOT NULL AUTO_INCREMENT,
  `Num` int(11) NOT NULL,
  `vaccinesId` bigint(20) NOT NULL,
  `InoculationId` bigint(20) NOT NULL,
...
-- ----------------------------
-- Records of inoculation_history
-- ----------------------------
INSERT INTO `inoculation_history` VALUES ('1', '1', '1', '1', '2023-01-31 02:04:42', '2');
INSERT INTO `inoculation_history` VALUES ('2', '1', '9', '1', '2023-01-31 02:18:25', '2');
INSERT INTO `inoculation_history` VALUES ('3', '1', '4', '3', '2023-07-20 15:53:39', '9');
INSERT INTO `inoculation_history` VALUES ('4', '1', '4', '3', '2023-07-20 15:54:00', '9');
INSERT INTO `inoculation_history` VALUES ('5', '1', '1', '5', '2023-08-14 14:49:03', '15');
INSERT INTO `inoculation_history` VALUES ('6', '1', '1', '5', '2023-08-14 14:49:29', '15');
INSERT INTO `inoculation_history` VALUES ('7', '1', '1', '5', '2023-08-14 15:27:45', '15');
INSERT INTO `inoculation_history` VALUES ('8', '1', '13', '7', '2023-08-14 15:47:36', '15');
INSERT INTO `inoculation_history` VALUES ('9', '1', '1', '2', '2023-08-14 15:47:50', '15');
INSERT INTO `inoculation_history` VALUES ('10', '1', '1', '5', '2023-08-14 15:48:00', '15');
INSERT INTO `inoculation_history` VALUES ('11', '1', '13', '7', '2023-08-18 09:37:25', '31');

-- ----------------------------
-- Table structure for inoculation_site
-- ----------------------------
DROP TABLE IF EXISTS `inoculation_site`;
CREATE TABLE `inoculation_site` (
  `InoculationId` bigint(20) NOT NULL AUTO_INCREMENT,
  `areaId` int(11) NOT NULL,
  `Detailed_address` varchar(500) DEFAULT NULL,
  `InoculationName` varchar(255) NOT NULL,
  `Starttime` datetime NOT NULL,
  `Endtime` datetime NOT NULL,
  PRIMARY KEY (`InoculationId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of inoculation_site
-- ----------------------------
INSERT INTO `inoculation_site` VALUES ('1', '110101', '东城区999号', '广州东城区新冠疫苗接种点', '2023-01-04 11:08:34', '2023-01-11 09:08:38');
INSERT INTO `inoculation_site` VALUES ('3', '120101', '999路999号', '从化新冠疫苗接种点24', '2023-01-30 00:00:00', '2023-08-28 00:00:00');
INSERT INTO `inoculation_site` VALUES ('4', '440184', '从化区城鳌大道984', '从化新冠疫苗接种点', '2023-02-01 00:00:00', '2023-02-09 00:00:00');
INSERT INTO `inoculation_site` VALUES ('5', '110101', '粤嵌学院', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00');
INSERT INTO `inoculation_site` VALUES ('7', '440184', '从化999999999号', '从化医学院', '2023-08-14 14:10:21', '2023-08-30 00:00:00');
...
CREATE TABLE `inspect_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inspect_type` varchar(50) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `inspect_type` VALUES ('1', '1密切接触者,密切接触者的密切接触者,一般接触者');
INSERT INTO `inspect_type` VALUES ('2', '2境外入境人员');
INSERT INTO `inspect_type` VALUES ('3', '3发热门诊（诊室）患者');
INSERT INTO `inspect_type` VALUES ('4', '4护患及陪护人员');
INSERT INTO `inspect_type` VALUES ('5', '5医疗机构工作人员（含行政、工勤人员）');
INSERT INTO `inspect_type` VALUES ('6', '6参与新冠肺炎疫情现场处置的防控工作人员');
INSERT INTO `inspect_type` VALUES ('7', '7隔离场所工作人员');
INSERT INTO `inspect_type` VALUES ('8', '8社区三人小组工作人员');
INSERT INTO `inspect_type` VALUES ('9', '9需纳入健康管理的检测对象');
INSERT INTO `inspect_type` VALUES ('10', '10健康码黄码人员');
INSERT INTO `inspect_type` VALUES ('11', '11口岸海关一线工作人员和边防检查人员（含工勤人员）');
INSERT INTO `inspect_type` VALUES ('12', '12进口冷链食品从业人员和市场监管系统一线工作人员');
INSERT INTO `inspect_type` VALUES ('13', '13直接接触境外入粤旅客托运行李的从业人员');
INSERT INTO `inspect_type` VALUES ('14', '14接触国际邮件快件的邮政快递行业从业人员');
INSERT INTO `inspect_type` VALUES ('15', '15国际（含港澳）港口码头一线工作人员');
INSERT INTO `inspect_type` VALUES ('16', '16陆空口岸和交通运输行业相关从业人员');
INSERT INTO `inspect_type` VALUES ('17', '17口岸城市相关岗位工作人员家属');
INSERT INTO `inspect_type` VALUES ('18', '18渔业相关作业人员');
INSERT INTO `inspect_type` VALUES ('19', '19特殊场所工作人员和服务对象（监管人员）');
INSERT INTO `inspect_type` VALUES ('20', '20定期抽样检测人员');
INSERT INTO `inspect_type` VALUES ('21', '21属地新冠肺炎防控指挥办确定的其他人员');

-- ----------------------------
-- Table structure for i_vaccines
-- ----------------------------
DROP TABLE IF EXISTS `i_vaccines`;
CREATE TABLE `i_vaccines` (
...
-- ----------------------------
-- Records of i_vaccines
-- ----------------------------
INSERT INTO `i_vaccines` VALUES ('1', '1', '3', '9');
INSERT INTO `i_vaccines` VALUES ('2', '1', '1', '16');
INSERT INTO `i_vaccines` VALUES ('3', '1', '2', '0');
INSERT INTO `i_vaccines` VALUES ('4', '1', '9', '8');
INSERT INTO `i_vaccines` VALUES ('5', '3', '4', '0');
INSERT INTO `i_vaccines` VALUES ('6', '3', '12', '1');
INSERT INTO `i_vaccines` VALUES ('7', '3', '3', '3');
INSERT INTO `i_vaccines` VALUES ('8', '4', '4', '2');
INSERT INTO `i_vaccines` VALUES ('9', '5', '1', '112');
INSERT INTO `i_vaccines` VALUES ('10', '5', '1', '111');
INSERT INTO `i_vaccines` VALUES ('11', '5', '1', '106');
INSERT INTO `i_vaccines` VALUES ('12', '7', '13', '27');

-- ----------------------------
-- Table structure for ls_sampling
-- ----------------------------
DROP TABLE IF EXISTS `ls_sampling`;
CREATE TABLE `ls_sampling` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `tel` varchar(24) NOT NULL,
  `document_type` int(11) NOT NULL,
  `document_No` varchar(24) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `document_type_FK` (`document_type`) USING BTREE,
  CONSTRAINT `document_type_FK` FOREIGN KEY (`document_type`) REFERENCES `document` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of ls_sampling
-- ----------------------------

-- ----------------------------
-- Table structure for nucleic_test
-- ----------------------------
DROP TABLE IF EXISTS `nucleic_test`;
CREATE TABLE `nucleic_test` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `time` datetime NOT NULL,
  `endtime` datetime DEFAULT NULL,
  `result` tinyint(4) DEFAULT NULL COMMENT '0阴性1阳性',
  `userid` bigint(20) NOT NULL,
  `detectionid` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of nucleic_test
-- ----------------------------
INSERT INTO `nucleic_test` VALUES ('2', '2022-09-01 00:50:30', '2022-09-03 00:50:38', '0', '2', '1');
INSERT INTO `nucleic_test` VALUES ('3', '2022-09-14 19:42:35', '2022-12-06 15:02:21', '0', '1', null);
INSERT INTO `nucleic_test` VALUES ('4', '2022-09-14 20:10:15', null, '0', '1', null);
INSERT INTO `nucleic_test` VALUES ('5', '2022-09-25 18:08:18', '2022-12-06 15:02:32', '0', '1', null);
INSERT INTO `nucleic_test` VALUES ('6', '2022-10-12 21:27:11', '2022-12-05 20:14:21', '0', '1', '5');
INSERT INTO `nucleic_test` VALUES ('7', '2022-10-12 21:27:14', '2022-12-06 11:27:32', '0', '1', '5');
INSERT INTO `nucleic_test` VALUES ('8', '2022-10-12 21:28:53', '2022-12-05 20:29:19', '1', '1', '6');
INSERT INTO `nucleic_test` VALUES ('9', '2022-10-12 21:36:41', '2022-12-05 20:24:30', '0', '1', '1');
INSERT INTO `nucleic_test` VALUES ('10', '2022-11-23 14:23:46', '2023-02-01 11:11:42', '0', '3', '1');
INSERT INTO `nucleic_test` VALUES ('11', '2022-11-23 14:23:55', '2023-07-20 16:02:42', '0', '3', '1');
INSERT INTO `nucleic_test` VALUES ('12', '2022-11-23 14:24:31', null, '0', '3', null);
INSERT INTO `nucleic_test` VALUES ('13', '2022-12-06 18:54:29', '2022-12-07 16:05:15', '0', '5', '1');
INSERT INTO `nucleic_test` VALUES ('14', '2023-02-01 10:12:53', '2023-02-01 10:52:52', '1', '2', '1');
INSERT INTO `nucleic_test` VALUES ('15', '2023-02-01 10:52:16', '2023-02-01 11:00:25', '1', '2', '1');
INSERT INTO `nucleic_test` VALUES ('16', '2023-02-01 11:24:03', '2023-02-01 11:25:06', '1', '7', '1');
INSERT INTO `nucleic_test` VALUES ('17', '2023-02-01 11:24:06', null, '0', '7', null);
INSERT INTO `nucleic_test` VALUES ('18', '2023-02-01 11:24:07', null, '0', '7', null);
INSERT INTO `nucleic_test` VALUES ('19', '2023-07-20 15:14:56', '2023-07-20 15:20:43', '1', '6', '1');
INSERT INTO `nucleic_test` VALUES ('20', '2023-07-20 15:55:23', '2023-07-20 15:55:45', '0', '6', '1');
INSERT INTO `nucleic_test` VALUES ('21', '2023-07-20 15:56:03', '2023-07-20 15:56:14', '0', '6', '1');
INSERT INTO `nucleic_test` VALUES ('22', '2023-08-14 15:49:47', null, '0', '15', null);
INSERT INTO `nucleic_test` VALUES ('23', '2023-08-14 16:10:04', '2023-08-14 16:55:13', '1', '15', '1');
INSERT INTO `nucleic_test` VALUES ('24', '2023-08-14 17:05:42', '2023-08-14 17:06:08', '0', '15', '1');
INSERT INTO `nucleic_test` VALUES ('25', '2023-08-14 17:13:26', '2023-08-14 17:13:32', '0', '15', '1');
INSERT INTO `nucleic_test` VALUES ('26', '2023-08-14 17:21:31', '2023-08-14 17:21:42', '0', '15', '1');
INSERT INTO `nucleic_test` VALUES ('27', '2023-08-14 17:21:36', '2023-08-14 17:21:49', '1', '15', '1');
INSERT INTO `nucleic_test` VALUES ('28', '2023-08-18 09:40:17', '2023-08-18 09:40:35', '0', '31', '1');
INSERT INTO `nucleic_test` VALUES ('29', '2023-08-18 10:05:29', '2023-08-18 10:05:41', '1', '31', '1');
INSERT INTO `nucleic_test` VALUES ('30', '2023-08-18 10:22:49', '2023-08-18 10:23:05', '1', '31', '1');
INSERT INTO `nucleic_test` VALUES ('31', '2023-08-18 10:23:22', '2023-08-18 10:23:28', '0', '31', '1');
...
CREATE TABLE `reservation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vaccinesId` int(11) DEFAULT NULL,
  `vaccinesname` varchar(255) DEFAULT NULL,
  `InoculationId` int(11) DEFAULT NULL,
  `inoculationname` varchar(255) DEFAULT NULL,
  `starttime` datetime DEFAULT NULL,
  `endtime` datetime DEFAULT NULL,
  `reservationTime` datetime DEFAULT NULL,
  `userId` int(11) DEFAULT NULL,
  `status` int(11) DEFAULT NULL COMMENT '0已完成1进行中2未完成',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `reservation` VALUES ('1', '1', '国药北京生物新冠灭活疫苗', '1', '广州东城区新冠疫苗接种点', '2023-01-04 11:08:34', '2023-01-11 09:08:38', '2023-01-31 00:51:49', '2', '0');
INSERT INTO `reservation` VALUES ('2', '3', '武汉生物新冠疫苗', '1', '广州东城区新冠疫苗接种点', '2023-01-04 11:08:34', '2023-01-11 09:08:38', '2023-01-31 01:04:19', '2', '2');
INSERT INTO `reservation` VALUES ('3', '9', '国药北京生物新冠灭活疫苗', '1', '广州东城区新冠疫苗接种点', '2023-01-04 11:08:34', '2023-01-11 09:08:38', '2023-01-31 01:08:12', '2', '0');
INSERT INTO `reservation` VALUES ('4', '12', '魔都生物6', '3', '从化新冠疫苗接种点24', '2023-01-30 00:00:00', '2023-01-31 00:00:00', '2023-01-31 01:24:40', '2', '1');
INSERT INTO `reservation` VALUES ('5', '9', '国药北京生物新冠灭活疫苗', '1', '广州东城区新冠疫苗接种点', '2023-01-04 11:08:34', '2023-01-11 09:08:38', '2023-01-31 02:35:41', '2', '2');
INSERT INTO `reservation` VALUES ('6', '4', '天津康希诺腺病毒载体疫苗', '3', '从化新冠疫苗接种点24', '2023-01-30 00:00:00', '2023-01-31 00:00:00', '2023-01-31 02:35:46', '2', '1');
INSERT INTO `reservation` VALUES ('7', '4', '天津康希诺腺病毒载体疫苗', '4', '从化新冠疫苗接种点', '2023-02-01 00:00:00', '2023-02-09 00:00:00', '2023-02-01 09:40:21', '2', '1');
INSERT INTO `reservation` VALUES ('8', '4', '天津康希诺腺病毒载体疫苗', '3', '从化新冠疫苗接种点24', '2023-01-30 00:00:00', '2023-08-28 00:00:00', '2023-07-20 15:53:26', '9', '0');
INSERT INTO `reservation` VALUES ('9', '4', '天津康希诺腺病毒载体疫苗', '3', '从化新冠疫苗接种点24', '2023-01-30 00:00:00', '2023-08-28 00:00:00', '2023-07-20 15:53:58', '9', '0');
INSERT INTO `reservation` VALUES ('10', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-07-27 16:41:15', '2', '1');
INSERT INTO `reservation` VALUES ('11', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-07-27 17:00:19', '4', '1');
INSERT INTO `reservation` VALUES ('12', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-07-27 17:02:54', '4', '1');
INSERT INTO `reservation` VALUES ('13', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-07-27 17:04:23', '4', '1');
INSERT INTO `reservation` VALUES ('14', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-07-27 17:22:10', '1', '1');
INSERT INTO `reservation` VALUES ('15', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-08-14 14:18:50', '15', '0');
INSERT INTO `reservation` VALUES ('16', '1', '从化生物', '5', '从化医学院', '2023-08-14 14:10:21', '2023-08-30 00:00:00', '2023-08-14 14:24:04', '15', '1');
INSERT INTO `reservation` VALUES ('17', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-08-14 14:26:29', '15', '0');
INSERT INTO `reservation` VALUES ('18', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-08-14 14:27:46', '15', '0');
INSERT INTO `reservation` VALUES ('19', '1', '从化生物', '5', '从化医学院', '2023-08-14 14:10:21', '2023-08-30 00:00:00', '2023-08-14 14:28:52', '15', '2');
INSERT INTO `reservation` VALUES ('20', '1', '武汉生物新冠疫苗', '5', '从化新冠疫苗接种点24', '2023-01-30 00:00:00', '2023-08-28 00:00:00', '2023-08-14 15:00:52', '15', '1');
INSERT INTO `reservation` VALUES ('21', '1', '魔都生物6', '5', '从化新冠疫苗接种点24', '2023-01-30 00:00:00', '2023-08-28 00:00:00', '2023-08-14 15:14:39', '15', '1');
INSERT INTO `reservation` VALUES ('22', '1', '国药北京生物新冠灭活疫苗', '5', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-08-14 15:17:38', '15', '0');
INSERT INTO `reservation` VALUES ('23', '1', '国药北京生物新冠灭活疫苗', '2', '粤嵌新冠疫苗接种点', '2023-07-27 15:34:20', '2023-08-31 00:00:00', '2023-08-14 15:28:26', '15', '0');
INSERT INTO `reservation` VALUES ('24', '1', '从化生物', '5', '从化医学院', '2023-08-14 14:10:21', '2023-08-30 00:00:00', '2023-08-14 15:39:43', '15', '1');
INSERT INTO `reservation` VALUES ('25', '13', '从化生物', '7', '从化医学院', '2023-08-14 14:10:21', '2023-08-30 00:00:00', '2023-08-14 15:47:30', '15', '0');
INSERT INTO `reservation` VALUES ('26', '13', '从化生物', '7', '从化医学院', '2023-08-14 14:10:21', '2023-08-30 00:00:00', '2023-08-18 09:37:23', '31', '0');
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '群众');
INSERT INTO `role` VALUES ('2', '医生');
INSERT INTO `role` VALUES ('3', '系统超级管理员');
...
CREATE TABLE `trip` (
  ...
  `tripStatus` tinyint(4) DEFAULT NULL,
  `userId` bigint(20) DEFAULT NULL,
  `Detailed_address` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`tripId`) USING BTREE,
  KEY `userId_FK` (`userId`) USING BTREE,
...
-- Records of trip
-- ----------------------------
INSERT INTO `trip` VALUES ('1', '2022-08-19 15:53:54', '2022-08-18 15:53:58', '155', '1', '2', '广州市从化区城鳌大道999');
...
CREATE TABLE `user` (
  ...
  KEY `areaId_FK` (`roleId`) USING BTREE,
  CONSTRAINT `areaId_FK` FOREIGN KEY (`roleId`) REFERENCES `role` (`roleId`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '张三', '女', 'bg2.jpg', '123456', '262531545@qq.com', '13954265784', '440825199406013014', '1', '1', '广东省广州市天河区999号', '0');
INSERT INTO `user` VALUES ('2', '李四', '女', 'blankbg.png', '123456', '262531545@qq.com', '13954265785', '440825199406013017', '2', null, '广东省广州市从化区城鳌大道999号666', '1');
INSERT INTO `user` VALUES ('3', '王五', '男', '2.jpg', '123456', '262531545@qq.com', '15487695478', '440825199406013018', '1', null, '广东省广州市从化区城鳌大道999号', '2');
INSERT INTO `user` VALUES ('4', '赵小六', '女', '34wv3wlhime.jpg', '123456', '265454@qq.com', '13922064578', '440825199406013008', '2', null, '广东省广州市黄埔区黄陂', '0');
INSERT INTO `user` VALUES ('5', '老谢', '女', 'laoxie.jpg', '123456', null, '18376622502', '440825199406013009', '2', null, null, '0');
INSERT INTO `user` VALUES ('6', '孙七', '男', 'blankbg.png', '123456', '2625312153@qq.com', '13922075478', '440825199406023029', '1', null, '广东省广州市天河区999号5', '0');
INSERT INTO `user` VALUES ('7', '钱八', '男', 'form-left-img.gif', '123456', '262531458@qq.com', '13922064358', '440823199606043019', null, null, '广东省广州市天河区999号', '2');
INSERT INTO `user` VALUES ('15', '毛磊', '男', '7b84ee3a4dd64837a0ff13ba2ab2baa.jpg', '111111', '121212121@qq.com', '12546468577', '440823199606043012', '2', null, '广东省广州市从化区123号', '2');
INSERT INTO `user` VALUES ('30', 'yao', '男', '6bc5d39b4dcf9689f1ae50661ea481a.jpg', '333333', '252525252@qq.com', '13425251255', '433127199902020044', '2', null, '广东省广州市从化区123号', '0');
INSERT INTO `user` VALUES ('31', 'yml', '男', '0ebb1af224289da46d0e0affcbc9652.jpg', '111111', '121212120@qq.com', '12345678910', '433123200110020011', '2', null, '广东省广州市从化区粤嵌123', '0');
...
CREATE TABLE `vaccines` (
  `vaccinesId` bigint(20) NOT NULL AUTO_INCREMENT,
  `vaccinesName` varchar(255) NOT NULL,
  `manufactor` varchar(255) NOT NULL,
  `vacctype` varchar(50) NOT NULL,
  `describes` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`vaccinesId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of vaccines
-- ----------------------------
INSERT INTO `vaccines` VALUES ('1', '国药北京生物新冠灭活疫苗', '北京生物', '灭活疫苗', '灭活疫苗7');
INSERT INTO `vaccines` VALUES ('2', '北京科兴中维新冠肺炎疫苗', '科兴中维', '重组亚单位疫苗', '重组亚单位疫苗3');
INSERT INTO `vaccines` VALUES ('3', '武汉生物新冠疫苗', '武汉生物', '重组亚单位疫苗', '重组亚单位疫苗');
INSERT INTO `vaccines` VALUES ('4', '天津康希诺腺病毒载体疫苗', '康希诺', '腺病毒载体疫苗', '腺病毒载体疫苗');
INSERT INTO `vaccines` VALUES ('5', '智飞生物重组新冠疫苗（CHO细胞）', '志飞生物和中国科学院微生物研究所', '重组亚单位疫苗', '重组亚单位疫苗');
INSERT INTO `vaccines` VALUES ('6', '北京生物3', '北京生物6', '北京生物9', '北京生物6');
INSERT INTO `vaccines` VALUES ('7', '国药北京生物新冠灭活疫苗', '北京生物', '灭活疫苗', '灭活疫苗');
INSERT INTO `vaccines` VALUES ('8', '北京生物4', '北京生物', '北京生物2', '北京生物2');
INSERT INTO `vaccines` VALUES ('9', '国药北京生物新冠灭活疫苗', '北京生物5', '灭活疫苗6', '灭活疫苗7');
INSERT INTO `vaccines` VALUES ('10', '魔都新疫苗', '北京生物5', '灭活疫苗', '123456');
INSERT INTO `vaccines` VALUES ('12', '魔都生物6', '魔都生物', '重组亚单位疫苗', '重组亚单位疫苗');
INSERT INTO `vaccines` VALUES ('13', '从化生物', '从化医学生物院', '从化cc', '从化生物cc');
